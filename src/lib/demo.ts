...
export const DEMO_PACIENTES: Paciente[] = [
  ...
  { id:'p2', nome:'Carla Nunes',   avatar:'CN', nascimento:'1997-07-22', sexo:'F', fone:'5511999990002', email:'',             cid:'',      modalidade:'Presencial', local_id:'unimed',     perfil:['adulto'],  valor_sessao:200, venc_dia:6,  sessoes_total:12, devedor_total:0,   ativo:true, obs:'' },
  ...
  { id:'p4', nome:'Paula Mendes',  avatar:'PM', nascimento:'1999-07-03', sexo:'F', fone:'5511999990004', email:'',             cid:'',      modalidade:'Presencial', local_id:'ceped', perfil:['adulto'],  valor_sessao:220, venc_dia:15, sessoes_total:8,  devedor_total:0,   ativo:true, obs:'' },
  { id:'p5', nome:'Rafael Costa',  avatar:'RC', nascimento:'1992-05-18', sexo:'M', fone:'5511999990005', email:'',             cid:'F40.1', modalidade:'Online',     local_id:'ceped', perfil:['adulto'],          valor_sessao:180, venc_dia:20, sessoes_total:15, devedor_total:0,   ativo:true, obs:'' },
  ...
  { id:'p7', nome:'Sofia Lima',    avatar:'SL', nascimento:'2017-04-12', sexo:'F', fone:'5511999990008', email:'',             cid:'F84.0', modalidade:'Presencial', local_id:'aquarela',   perfil:['crianca','crianca_neuro'], valor_sessao:190, venc_dia:10, sessoes_total:10, devedor_total:0, ativo:true, obs:'TEA nível 1.' },
  { id:'p8', nome:'Pedro Mendes',  avatar:'PD', nascimento:'2018-08-20', sexo:'M', fone:'5511999990009', email:'',             cid:'F90.0', modalidade:'Presencial', local_id:'unimed',     perfil:['crianca','crianca_neuro'], valor_sessao:190, venc_dia:15, sessoes_total:6,  devedor_total:0, ativo:true, obs:'TDAH combinado.' },
]
